...
# Load enriched IOCs from VirusTotal enrichment output
...
# Extract VirusTotal summary for description
def vt_summary(data):
    if not data:
        return ""
...
# Free-text entries for detection rules, phishing indicators, commands
